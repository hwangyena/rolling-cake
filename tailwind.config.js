...
export const theme = {
  extend: {
    ...
    fontSize: {
      h1: ['1.5em', { lineHeight: '140%' }],
      h2: ['1.375em', { lineHeight: '140%' }],
      h3: ['1.25em', { lineHeight: '150%' }],
      h4: ['1.125em', { lineHeight: '150%' }],
      h5: ['1.5em', { lineHeight: '140%' }],
      t1: ['1em', { lineHeight: '140%' }],
      t2: ['1em', { lineHeight: '150%' }],
      b1: ['1.05em', { lineHeight: '140%' }],
      b2: ['1em', { lineHeight: '140%' }],
      b3: ['0.75em', { lineHeight: '140%' }],
      btn1: ['1em', { lineHeight: '120%' }],
      btn2: ['0.75em', { lineHeight: '120%' }],
      cap: ['0.625em', { lineHeight: '120%' }],
      effect_t: ['1.375em', { lineHeight: '140%', letterSpacing: '-0.3px' }],
      effect_b: ['0.875em', { lineHeight: '140%' }],
    },
    backgroundImage: {
